...
pipeline {
    ...
    stage('SonarQube Inspection') {
        steps {
            withSonarQubeEnv('SonarQube') { 
                ...
                -Dsonar.host.url=http://172.31.89.49:9000 \
  ...
  post {
    always {
        ...
        slackSend channel: 'end-to-end-cicd-pipeline-notifications', //update and provide your channel name
